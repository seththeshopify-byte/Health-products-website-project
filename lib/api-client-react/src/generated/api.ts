 ...
 */
export const deleteCourse = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const enrollCourse = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
...
export const getGetCourseQuizUrl = (id: number,) => {
 ...
 */
export const getCourseQuiz = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<QuizQuestionPublic[]> => {

  return customFetch<QuizQuestionPublic[]>(getGetCourseQuizUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetCourseQuizQueryKey = (id: number,) => {
    return [
    `/api/courses/${id}/quiz`
    ] as const;
    }
...
export const getGetCourseQuizQueryOptions = <TData = Awaited<ReturnType<typeof getCourseQuiz>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCourseQuiz>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCourseQuizQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCourseQuiz>>> = ({ signal }) => getCourseQuiz(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCourseQuiz>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetCourseQuiz<TData = Awaited<ReturnType<typeof getCourseQuiz>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCourseQuiz>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCourseQuizQueryOptions(id,options)
...
export const getSubmitCourseQuizUrl = (id: number,) => {




  return `/api/courses/${id}/quiz/submit`
}

/**
 * @summary Submit quiz answers and get score
 */
export const submitCourseQuiz = async (id: number,
    quizSubmission: QuizSubmission, options?: Parameters<typeof customFetch>[1]): Promise<QuizResult> => {

  return customFetch<QuizResult>(getSubmitCourseQuizUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSubmitCourseQuizMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitCourseQuiz>>, TError,{id: number;data: BodyType<QuizSubmission>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitCourseQuiz>>, TError,{id: number;data: BodyType<QuizSubmission>}, TContext> => {

const mutationKey = ['submitCourseQuiz'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitCourseQuiz>>, {id: number;data: BodyType<QuizSubmission>}> = (props) => {
          const {id,data} = props ?? {};

          return  submitCourseQuiz(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitCourseQuizMutationResult = NonNullable<Awaited<ReturnType<typeof submitCourseQuiz>>>
    export type SubmitCourseQuizMutationBody = BodyType<QuizSubmission>
    export type SubmitCourseQuizMutationError = ErrorType<unknown>

    /**
 * @summary Submit quiz answers and get score
 */
export const useSubmitCourseQuiz = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitCourseQuiz>>, TError,{id: number;data: BodyType<QuizSubmission>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof submitCourseQuiz>>,
        TError,
        {id: number;data: BodyType<QuizSubmission>},
        TContext
      > => {
      return useMutation(getSubmitCourseQuizMutationOptions(options));
    }

export const getGetCourseQuizResultUrl = (id: number,) => {




  return `/api/courses/${id}/quiz/result`
}

/**
 * @summary Get the user's best quiz result for a course
 */
export const getCourseQuizResult = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<QuizResult> => {

  return customFetch<QuizResult>(getGetCourseQuizResultUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetCourseQuizResultQueryKey = (id: number,) => {
    return [
    `/api/courses/${id}/quiz/result`
    ] as const;
    }


export const getGetCourseQuizResultQueryOptions = <TData = Awaited<ReturnType<typeof getCourseQuizResult>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCourseQuizResult>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCourseQuizResultQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCourseQuizResult>>> = ({ signal }) => getCourseQuizResult(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCourseQuizResult>>, TError, TData> & { queryKey: QueryKey }
}

export type GetCourseQuizResultQueryResult = NonNullable<Awaited<ReturnType<typeof getCourseQuizResult>>>
export type GetCourseQuizResultQueryError = ErrorType<unknown>
...
export function useGetCourseQuizResult<TData = Awaited<ReturnType<typeof getCourseQuizResult>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCourseQuizResult>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCourseQuizResultQueryOptions(id,options)
...
export const getListCourseQuizQuestionsUrl = (id: number,) => {




  return `/api/courses/${id}/quiz/questions`
}

/**
 * @summary List quiz questions with correct answers (admin)
 */
export const listCourseQuizQuestions = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<QuizQuestion[]> => {

  return customFetch<QuizQuestion[]>(getListCourseQuizQuestionsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getListCourseQuizQuestionsQueryKey = (id: number,) => {
    return [
...
export const getListCourseQuizQuestionsQueryOptions = <TData = Awaited<ReturnType<typeof listCourseQuizQuestions>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listCourseQuizQuestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListCourseQuizQuestionsQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listCourseQuizQuestions>>> = ({ signal }) => listCourseQuizQuestions(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listCourseQuizQuestions>>, TError, TData> & { queryKey: QueryKey }
}

export type ListCourseQuizQuestionsQueryResult = NonNullable<Awaited<ReturnType<typeof listCourseQuizQuestions>>>
export type ListCourseQuizQuestionsQueryError = ErrorType<unknown>
...
export function useListCourseQuizQuestions<TData = Awaited<ReturnType<typeof listCourseQuizQuestions>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listCourseQuizQuestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListCourseQuizQuestionsQueryOptions(id,options)
...
export const getCreateCourseQuizQuestionUrl = (id: number,) => {
 ...
 */
export const createCourseQuizQuestion = async (id: number,
    quizQuestionInput: QuizQuestionInput, options?: Parameters<typeof customFetch>[1]): Promise<QuizQuestion> => {

  return customFetch<QuizQuestion>(getCreateCourseQuizQuestionUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateCourseQuizQuestionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createCourseQuizQuestion>>, TError,{id: number;data: BodyType<QuizQuestionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createCourseQuizQuestion>>, TError,{id: number;data: BodyType<QuizQuestionInput>}, TContext> => {

const mutationKey = ['createCourseQuizQuestion'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createCourseQuizQuestion>>, {id: number;data: BodyType<QuizQuestionInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  createCourseQuizQuestion(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateCourseQuizQuestionMutationResult = NonNullable<Awaited<ReturnType<typeof createCourseQuizQuestion>>>
    export type CreateCourseQuizQuestionMutationBody = BodyType<QuizQuestionInput>
    export type CreateCourseQuizQuestionMutationError = ErrorType<unknown>

    /**
 * @summary Add a quiz question to a course (admin)
 */
export const useCreateCourseQuizQuestion = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createCourseQuizQuestion>>, TError,{id: number;data: BodyType<QuizQuestionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createCourseQuizQuestion>>,
        TError,
        {id: number;data: BodyType<QuizQuestionInput>},
        TContext
      > => {
      return useMutation(getCreateCourseQuizQuestionMutationOptions(options));
    }

export const getUpdateCourseQuizQuestionUrl = (id: number,
    questionId: number,) => {




  return `/api/courses/${id}/quiz/questions/${questionId}`
}

/**
 * @summary Update a quiz question (admin)
 */
export const updateCourseQuizQuestion = async (id: number,
    questionId: number,
    quizQuestionInput: QuizQuestionInput, options?: Parameters<typeof customFetch>[1]): Promise<QuizQuestion> => {

  return customFetch<QuizQuestion>(getUpdateCourseQuizQuestionUrl(id,questionId),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateCourseQuizQuestionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateCourseQuizQuestion>>, TError,{id: number;questionId: number;data: BodyType<QuizQuestionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateCourseQuizQuestion>>, TError,{id: number;questionId: number;data: BodyType<QuizQuestionInput>}, TContext> => {

const mutationKey = ['updateCourseQuizQuestion'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateCourseQuizQuestion>>, {id: number;questionId: number;data: BodyType<QuizQuestionInput>}> = (props) => {
          const {id,questionId,data} = props ?? {};

          return  updateCourseQuizQuestion(id,questionId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateCourseQuizQuestionMutationResult = NonNullable<Awaited<ReturnType<typeof updateCourseQuizQuestion>>>
    export type UpdateCourseQuizQuestionMutationBody = BodyType<QuizQuestionInput>
    export type UpdateCourseQuizQuestionMutationError = ErrorType<unknown>

    /**
 * @summary Update a quiz question (admin)
 */
export const useUpdateCourseQuizQuestion = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateCourseQuizQuestion>>, TError,{id: number;questionId: number;data: BodyType<QuizQuestionInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateCourseQuizQuestion>>,
        TError,
        {id: number;questionId: number;data: BodyType<QuizQuestionInput>},
        TContext
      > => {
      return useMutation(getUpdateCourseQuizQuestionMutationOptions(options));
    }

export const getDeleteCourseQuizQuestionUrl = (id: number,
    questionId: number,) => {
 ...
 */
export const deleteCourseQuizQuestion = async (id: number,
    questionId: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getDeleteCourseQuizQuestionUrl(id,questionId),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteCourseQuizQuestionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteCourseQuizQuestion>>, TError,{id: number;questionId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteCourseQuizQuestion>>, TError,{id: number;questionId: number}, TContext> => {

const mutationKey = ['deleteCourseQuizQuestion'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteCourseQuizQuestion>>, {id: number;questionId: number}> = (props) => {
          const {id,questionId} = props ?? {};

          return  deleteCourseQuizQuestion(id,questionId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteCourseQuizQuestionMutationResult = NonNullable<Awaited<ReturnType<typeof deleteCourseQuizQuestion>>>

    export type DeleteCourseQuizQuestionMutationError = ErrorType<unknown>

    /**
 * @summary Delete a quiz question (admin)
 */
export const useDeleteCourseQuizQuestion = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteCourseQuizQuestion>>, TError,{id: number;questionId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteCourseQuizQuestion>>,
        TError,
        {id: number;questionId: number},
        TContext
      > => {
      return useMutation(getDeleteCourseQuizQuestionMutationOptions(options));
    }
 ...
 */
export const listTestimonials = async (params?: ListTestimonialsParams, options?: Parameters<typeof customFetch>[1]): Promise<Testimonial[]> => {
 ...
 */
export const deleteTestimonial = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const deleteEvent = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const stripeWebhook = async ( options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const listBookingSlots = async ( options?: Parameters<typeof customFetch>[1]): Promise<BookingSlot[]> => {
 ...
 */
export const createBookingSlot = async (bookingSlotInput: BookingSlotInput, options?: Parameters<typeof customFetch>[1]): Promise<BookingSlot> => {
 ...
 */
export const deleteBookingSlot = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const listCommissionEvents = async ( options?: Parameters<typeof customFetch>[1]): Promise<CommissionEvent[]> => {
 ...
 */
export const markCommissionPaid = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<CommissionEvent> => {
 ...
 */
export const createShippingZone = async (shippingZoneInput: ShippingZoneInput, options?: Parameters<typeof customFetch>[1]): Promise<ShippingZone> => {
...
export const updateShippingZone = async (id: number,
    shippingZoneUpdate: ShippingZoneUpdate, options?: Parameters<typeof customFetch>[1]): Promise<ShippingZone> => {
 ...
 */
export const deleteShippingZone = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
 ...
 */
export const getZoomLink = async ( options?: Parameters<typeof customFetch>[1]): Promise<ZoomSettings> => {
 ...
 */
export const updateZoomLink = async (zoomSettingsUpdate: ZoomSettingsUpdate, options?: Parameters<typeof customFetch>[1]): Promise<ZoomSettings> => {
...
export const getListRoomsUrl = () => { return `/api/rooms` }
export const listRooms = async (options?: Parameters<typeof customFetch>[1]): Promise<Room[]> => {
  return customFetch<Room[]>(getListRoomsUrl(), { ...options, method: 'GET' });
}
export const getListRoomsQueryKey = () => { return [`/api/rooms`] as const; }
...
export function useListRooms<TData = Awaited<ReturnType<typeof listRooms>>, TError = ErrorType<unknown>>(options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof listRooms>>, TError, TData>, request?: SecondParameter<typeof customFetch> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
  const queryOptions = getListRoomsQueryOptions(options);
  const query = useQuery(queryOptions) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
  return withQueryKey(query, queryOptions.queryKey);
}

export const getCreateRoomUrl = () => { return `/api/rooms` }
export const createRoom = async (roomInput: RoomInput, options?: Parameters<typeof customFetch>[1]): Promise<Room> => {
  return customFetch<Room>(getCreateRoomUrl(), { ...options, method: 'POST', headers: { 'Content-Type': 'application/json', ...options?.headers }, body: JSON.stringify(roomInput) });
}
export const getCreateRoomMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof createRoom>>, TError, { data: BodyType<RoomInput> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof createRoom>>, TError, { data: BodyType<RoomInput> }, TContext> => {
  const mutationKey = ['createRoom'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof createRoom>>, { data: BodyType<RoomInput> }> = (props) => { const { data } = props ?? {}; return createRoom(data, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useCreateRoom = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof createRoom>>, TError, { data: BodyType<RoomInput> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof createRoom>>, TError, { data: BodyType<RoomInput> }, TContext> => {
  return useMutation(getCreateRoomMutationOptions(options));
}

export const getGetRoomUrl = (id: number) => { return `/api/rooms/${id}` }
export const getRoom = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<Room> => {
  return customFetch<Room>(getGetRoomUrl(id), { ...options, method: 'GET' });
}
export const getGetRoomQueryKey = (id: number) => { return [`/api/rooms/${id}`] as const; }
...
export function useGetRoom<TData = Awaited<ReturnType<typeof getRoom>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof getRoom>>, TError, TData>, request?: SecondParameter<typeof customFetch> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
  const queryOptions = getGetRoomQueryOptions(id, options);
  const query = useQuery(queryOptions) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
  return withQueryKey(query, queryOptions.queryKey);
}

export const getUpdateRoomUrl = (id: number) => { return `/api/rooms/${id}` }
export const updateRoom = async (id: number, roomUpdate: RoomUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Room> => {
  return customFetch<Room>(getUpdateRoomUrl(id), { ...options, method: 'PATCH', headers: { 'Content-Type': 'application/json', ...options?.headers }, body: JSON.stringify(roomUpdate) });
}
export const getUpdateRoomMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateRoom>>, TError, { id: number; data: BodyType<RoomUpdate> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof updateRoom>>, TError, { id: number; data: BodyType<RoomUpdate> }, TContext> => {
  const mutationKey = ['updateRoom'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateRoom>>, { id: number; data: BodyType<RoomUpdate> }> = (props) => { const { id, data } = props ?? {}; return updateRoom(id, data, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useUpdateRoom = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateRoom>>, TError, { id: number; data: BodyType<RoomUpdate> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof updateRoom>>, TError, { id: number; data: BodyType<RoomUpdate> }, TContext> => {
  return useMutation(getUpdateRoomMutationOptions(options));
}

export const getDeleteRoomUrl = (id: number) => { return `/api/rooms/${id}` }
export const deleteRoom = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
  return customFetch<SuccessResponse>(getDeleteRoomUrl(id), { ...options, method: 'DELETE' });
}
export const getDeleteRoomMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteRoom>>, TError, { id: number }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof deleteRoom>>, TError, { id: number }, TContext> => {
  const mutationKey = ['deleteRoom'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteRoom>>, { id: number }> = (props) => { const { id } = props ?? {}; return deleteRoom(id, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useDeleteRoom = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteRoom>>, TError, { id: number }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof deleteRoom>>, TError, { id: number }, TContext> => {
...
export const listMenuItems = async (params?: ListMenuItemsParams, options?: Parameters<typeof customFetch>[1]): Promise<MenuItem[]> => {
  return customFetch<MenuItem[]>(getListMenuItemsUrl(params), { ...options, method: 'GET' });
}
...
export function useListMenuItems<TData = Awaited<ReturnType<typeof listMenuItems>>, TError = ErrorType<unknown>>(params?: ListMenuItemsParams, options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof listMenuItems>>, TError, TData>, request?: SecondParameter<typeof customFetch> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
  const queryOptions = getListMenuItemsQueryOptions(params, options);
  const query = useQuery(queryOptions) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
  return withQueryKey(query, queryOptions.queryKey);
}

export const getCreateMenuItemUrl = () => { return `/api/menu-items` }
export const createMenuItem = async (menuItemInput: MenuItemInput, options?: Parameters<typeof customFetch>[1]): Promise<MenuItem> => {
  return customFetch<MenuItem>(getCreateMenuItemUrl(), { ...options, method: 'POST', headers: { 'Content-Type': 'application/json', ...options?.headers }, body: JSON.stringify(menuItemInput) });
}
export const getCreateMenuItemMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof createMenuItem>>, TError, { data: BodyType<MenuItemInput> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof createMenuItem>>, TError, { data: BodyType<MenuItemInput> }, TContext> => {
  const mutationKey = ['createMenuItem'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof createMenuItem>>, { data: BodyType<MenuItemInput> }> = (props) => { const { data } = props ?? {}; return createMenuItem(data, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useCreateMenuItem = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof createMenuItem>>, TError, { data: BodyType<MenuItemInput> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof createMenuItem>>, TError, { data: BodyType<MenuItemInput> }, TContext> => {
  return useMutation(getCreateMenuItemMutationOptions(options));
}

export const getGetMenuItemUrl = (id: number) => { return `/api/menu-items/${id}` }
export const getMenuItem = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MenuItem> => {
  return customFetch<MenuItem>(getGetMenuItemUrl(id), { ...options, method: 'GET' });
}
export const getGetMenuItemQueryKey = (id: number) => { return [`/api/menu-items/${id}`] as const; }
...
export function useGetMenuItem<TData = Awaited<ReturnType<typeof getMenuItem>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof getMenuItem>>, TError, TData>, request?: SecondParameter<typeof customFetch> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
  const queryOptions = getGetMenuItemQueryOptions(id, options);
  const query = useQuery(queryOptions) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
  return withQueryKey(query, queryOptions.queryKey);
}

export const getUpdateMenuItemUrl = (id: number) => { return `/api/menu-items/${id}` }
export const updateMenuItem = async (id: number, menuItemUpdate: MenuItemUpdate, options?: Parameters<typeof customFetch>[1]): Promise<MenuItem> => {
  return customFetch<MenuItem>(getUpdateMenuItemUrl(id), { ...options, method: 'PATCH', headers: { 'Content-Type': 'application/json', ...options?.headers }, body: JSON.stringify(menuItemUpdate) });
}
export const getUpdateMenuItemMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateMenuItem>>, TError, { id: number; data: BodyType<MenuItemUpdate> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof updateMenuItem>>, TError, { id: number; data: BodyType<MenuItemUpdate> }, TContext> => {
  const mutationKey = ['updateMenuItem'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateMenuItem>>, { id: number; data: BodyType<MenuItemUpdate> }> = (props) => { const { id, data } = props ?? {}; return updateMenuItem(id, data, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useUpdateMenuItem = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateMenuItem>>, TError, { id: number; data: BodyType<MenuItemUpdate> }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof updateMenuItem>>, TError, { id: number; data: BodyType<MenuItemUpdate> }, TContext> => {
  return useMutation(getUpdateMenuItemMutationOptions(options));
}

export const getDeleteMenuItemUrl = (id: number) => { return `/api/menu-items/${id}` }
export const deleteMenuItem = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<SuccessResponse> => {
  return customFetch<SuccessResponse>(getDeleteMenuItemUrl(id), { ...options, method: 'DELETE' });
}
export const getDeleteMenuItemMutationOptions = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteMenuItem>>, TError, { id: number }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationOptions<Awaited<ReturnType<typeof deleteMenuItem>>, TError, { id: number }, TContext> => {
  const mutationKey = ['deleteMenuItem'];
  const { mutation: mutationOptions, request: requestOptions } = options ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ? options : { ...options, mutation: { ...options.mutation, mutationKey } } : { mutation: { mutationKey }, request: undefined };
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteMenuItem>>, { id: number }> = (props) => { const { id } = props ?? {}; return deleteMenuItem(id, requestOptions) };
  return { mutationFn, ...mutationOptions };
}
...
export const useDeleteMenuItem = <TError = ErrorType<unknown>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteMenuItem>>, TError, { id: number }, TContext>, request?: SecondParameter<typeof customFetch> }): UseMutationResult<Awaited<ReturnType<typeof deleteMenuItem>>, TError, { id: number }, TContext> => {
